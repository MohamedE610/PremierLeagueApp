...
public class RxErrorHandlingCallAdapterFactory extends CallAdapter.Factory {
    ...
    private static class RxCallAdapterWrapper<R> implements CallAdapter<R, Object> {
        ...
        private PremierLeagueException asRetrofitException(final Throwable throwable) {
            ...
            if (throwable instanceof TimeoutException || throwable instanceof SocketTimeoutException
                ...
                return NetworkException.INSTANCE.timeoutError(throwable);
            }

            // handle server down exception
            if (throwable instanceof ConnectException) {
                return NetworkException.INSTANCE.serverDownError(throwable);
            }
